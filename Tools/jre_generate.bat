...
set MODULES=java.base,java.logging,java.sql,java.sql.rowset,java.datatransfer,java.desktop,java.management,java.management.rmi,java.prefs,java.rmi,java.scripting,java.xml,jdk.unsupported,java.security.jgss
